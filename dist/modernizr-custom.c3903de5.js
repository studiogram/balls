...
!function (e, n, t) {
    ...
    for (var l in d) {
      if (d.hasOwnProperty(l)) {
        ...
        for (s = o(n.fn, "function") ? n.fn() : n.fn, i = 0; i < e.length; i++) {
          a = e[i], r = a.split("."), 1 === r.length ? Modernizr[r[0]] = s : (!Modernizr[r[0]] || Modernizr[r[0]] instanceof Boolean || (Modernizr[r[0]] = new Boolean(Modernizr[r[0]])), Modernizr[r[0]][r[1]] = s), f.push((s ? "" : "no-") + r.join("-"));
        }
      }
    }
  }
  ...
  function l(e, t, o, s) {
    ...
    if (parseInt(o, 10)) for (; o--;) {
      f = a("div"), f.id = s ? s[o] : c + (o + 1), p.appendChild(f);
    }
